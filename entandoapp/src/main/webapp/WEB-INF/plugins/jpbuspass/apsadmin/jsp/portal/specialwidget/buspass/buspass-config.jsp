...
<s:form action="saveConfig" namespace="/do/jpbuspass/Buspass/Page/SpecialWidget/jpbuspassBuspassConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="buspasssId" name="id" id="id" cssClass="form-control" />
